...
<body>
    ...
    <section class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="mt-4">
                    <form action="../route.php?route=atualizarPerfilCliente" method="POST" serialize class="border border-secondary rounded p-2">
                    ...
                    <form action="../route.php?route=atualizarSenhaCliente" method="POST" class="border border-secondary rounded p-2 mt-4">
