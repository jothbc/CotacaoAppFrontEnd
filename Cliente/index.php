...
<head>
    ...
    <script>
        function visualizarCotacao(pedido){
            window.location.href = '../CotacaoCliente/index.php?pedido=' + pedido
        }

        function editarCotacao(pedido) {
                ...
                <div class="mt-3">
                    ...
                    <table class="table table-dark">
                        ...
                        foreach ($lista as $key => $value) { ?>
                            <tbody>
                                <tr class="data-table">
                                    <td onclick="visualizarCotacao('<?= $value['pedido'] ?>')">
                                        <?= $value['pedido'] ?>
                                    </td>
                                    <td onclick="visualizarCotacao('<?= $value['pedido'] ?>')">
                                        <?= $value['descricao'] ?>
                                    </td>
                                    <td onclick="editarCotacao('<?= $value['pedido'] ?>')">
